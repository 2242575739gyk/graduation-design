...
public interface IProcessService {
    ...
    List<Task> findTodoTasks(String userId, String key, String processInstanceId);

    List<HistoricTaskInstance> findDoneTasks(String userId, String key, String processInstanceId);
