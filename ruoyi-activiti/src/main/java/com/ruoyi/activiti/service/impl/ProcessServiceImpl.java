...
public class ProcessServiceImpl implements IProcessService {
    ...
    @Override
    public List<Task> findTodoTasks(String userId, String key, String processInstanceId) {
    ...
    @Override
    public List<HistoricTaskInstance> findDoneTasks(String userId, String key, String processInstanceId) {
    ...
    public void cancelApply(String instanceId, String deleteReason) {
        ...
        if (!CollectionUtils.isEmpty(taskList)) {
            taskList.forEach(task -> {
                ...
                List<BizTodoItem> todoItemList = CollectionUtils.isEmpty(bizTodoItemService.selectBizTodoItemList(query)) ? null : bizTodoItemService.selectBizTodoItemList(query);

                if (!CollectionUtils.isEmpty(todoItemList)) {
                    todoItemList.forEach(bizTodoItem -> {
